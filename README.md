...
Note: This project uses a dual-license model. Feel free to check out the code here and/or build for free, or [download a built binary from Itch.io (donation supported, but allows to redeem without a donation)](https://mikethetech.itch.io/burnbin). 😊
